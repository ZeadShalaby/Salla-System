...
trait ResponseTrait
{
    ...
    // ??todo return response data for extract pdf
    public function returnExtractPDF(
        $key,
        $rating,
        $grammar_vocabulary_errors,
        $skills,
        $experience,
        $number_skills,
        $number_details,
        ...
        return response()->json([
            $key => [
                'status' => true,
                'errNum' => "S000", // رمز الخطأ، يمكن تحسينه ليعكس المزيد من المعلومات
                'rating' => $rating,
                'skills' => $skills,
                'number_skills' => $number_skills,
                'experience' => $experience,
                'number_details' => $number_details,
                'grammar_vocabulary_errors' => $grammar_vocabulary_errors, // استخدم اسمًا أكثر وضوحًا
                'number_of_issues' => $number_of_issues,
                'impact' => $impact,
                'number_of_impacts' => $number_of_impacts,
                'msg' => $msg,
                'is_subscribe' => $is_subscribe // إضافة حالة الاشتراك هنا
            ]
        ]);
    }
